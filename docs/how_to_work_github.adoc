...
Observera att det här inte säger något om ett projekts policy - utan beskriver bara ramarna.
En policy för ett projekt skulle mycket väl, som exempel, kunna bestämma att " vårt API ska vara på svenska", trots att det att ur språklagens tolking skulle vara ok att ha det på engelska.
...
* https://github.com/diggsweden[Digg:s GitHub] – (parallellespråkighet)
* https://www.swedenconnect.se/[Sweden Connect teknisk dokumentation] – exempel på arkitektur/slutanvändardokumentation (parallellspråkighet)  
