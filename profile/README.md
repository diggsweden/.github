...
- 📖 [**Handbok för arbete med öppen programvara**](https://diggsweden.github.io/opensource-docs/sv/)
Vår samlade vägledning: riktlinjer, checklistor, projektmall, terminologi och referensmaterial.
...
Aktuell lista över våra öppna källkodsprojekt finns i handboken: [Öppna källkodsprojekt](https://diggsweden.github.io/opensource-docs/sv/projekt/).
...
• :performing_arts:[ Digital identity](#performing_arts-digital-identity)
• :vulcan_salute:[ Friends](#vulcan_salute-friends)
• :hammer:[ Projects](#hammer-projects)
...
- 📖 [**Handbook for working with open source software**](https://diggsweden.github.io/opensource-docs/en/)
Our consolidated guidance: guidelines, checklists, project template, glossary, and reference material.
...
## :performing_arts: Digital identity
...
An up-to-date list of our open source projects is in the handbook: [Open source projects](https://diggsweden.github.io/opensource-docs/en/projects/).
